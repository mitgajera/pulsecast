...
export function AccountDashboard() {
  ...
  return <div className="flex min-h-0 flex-1 flex-col gap-3">
    ...
    <div className="scrollbar-hidden grid min-h-0 flex-1 gap-3 overflow-y-auto overscroll-contain lg:grid-cols-[minmax(0,1fr)_20rem] lg:overflow-hidden">
